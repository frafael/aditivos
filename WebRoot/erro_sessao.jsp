...
<body>
	<div class="box-erro">
		<div class="box-body-erro">
			<h3 class="titulo">Há uma sessão existente!</h3>
			<img src="<c:url value='/imagens/erro500.png'/>" height="107"/><br>
			<div class="mensagem" >
				<span style="font-size: 20px; color: #595959;">Você já está logado em uma empresa.</span>
			</div>
		</div>
