...
<body>
	<div class="box-erro">
		<div class="box-body-erro">
			<h3 class="titulo">P&#225;gina n&#227;o encontrada!</h3>
			<img src="<c:url value='/imagens/erro404.jpg'/>" height="107"/><br>
			<div class="mensagem" >
				<span style="font-size: 20px; color: #595959;">Essa p&#225;gina n&#227;o foi encontrada!</span>
			</div>
		</div>
